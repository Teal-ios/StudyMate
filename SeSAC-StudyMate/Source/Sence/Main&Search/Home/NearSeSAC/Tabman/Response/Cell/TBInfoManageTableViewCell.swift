//
//  TBInfoManageTableViewCell.swift
//  SeSAC-StudyMate
//
//  Created by 이병현 on 2023/01/02.
//
...
protocol TBsliderDelegate: AnyObject {
    func slider(min: Int, max: Int)
}

protocol TBWithdrawDelegate: AnyObject {
    func withdrawButtonTapped(tap: Bool)
}

final class TBInfoManageTableViewCell: BaseTableViewCell {
