...
| 22.12.09(금) | State에 따른 화면 이동 처리 수정 및 이력서 초안 구상         |                                                              |
| 22.12.10(토) | 개인 플젝 리펙토링                                           |                                                              |
| 22.12.11(일) | 이력서 틀 1차 작성 및 피드백                                 |                                                              |
| 22.12.12(월) | Readme 사용 기술 정리 업데이트                               |                                                              |
| 22.12.13(화) | 이력서 2차 작성 및 피드백                                    |                                                              |
| 22.12.14(수) | API 구성 및 새싹 찾기 중단 요청 구성                         |                                                              |
| 22.12.15(목) | Readme 정리                                                  |                                                              |
...
SearchView에 대한 부분에서 Snapshot에서 데이터를 뿌리는 도중, 어떻게 Hashable하게 만들어 줄 지에 대한 설정 및 셀 클릭에 대한 이벤트를 처리할 지에 대해 해결을 하지 못함. 디퍼블을 그리는 방법 이외에도 스냅샷에 대해 조금 더 이해하고 적용해볼 것.
...
- State에 따른 화면 이동 처리 수정 및 이력서 초안 구상
